---
name: to-spec
description: Turn the current conversation into a spec and publish it to the project issue tracker — no interview, just synthesis of what you've already discussed. This skill may only be invoked by another skill or by a user.
---
...
4. Self-review the spec with fresh eyes before publishing:
   - **Placeholder scan:** any TBDs, vague or incomplete requirements? Fix them.
