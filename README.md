...
**Delegation & review cores:** [implement-core](skills/implement-core/SKILL.md) · [codex-implementation](skills/codex-implementation/SKILL.md) · [claude-implement](skills/claude-implement/SKILL.md) · [review-core](skills/review-core/SKILL.md) · [codex-review](skills/codex-review/SKILL.md) · [claude-review](skills/claude-review/SKILL.md)

**Vocabulary & lenses:** [codebase-design](skills/codebase-design/SKILL.md) · [domain-modeling](skills/domain-modeling/SKILL.md) · [write-less](skills/write-less/SKILL.md) · [typescript-beautify](skills/typescript-beautify/SKILL.md)
